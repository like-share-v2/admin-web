    ...
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('LOWEST_PRICE')" required :error="errors.lowest_price">
                <el-input-number  style="width: 200px" v-model="mdl.lowest_price" controls-position="right" :min="0" :precision="2" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('LOWEST_PRICE') })"></el-input-number>
            </el-form-item>
