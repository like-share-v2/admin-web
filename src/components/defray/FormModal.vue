...
<!--            </el-form-item>-->
            ...
            <el-form-item label="IFSC" :error="errors.ifsc">
                <el-input v-model="data.ifsc" :placeholder="$i18n.t('PLEASE_INPUT', { value: 'IFSC' })"></el-input>
            </el-form-item>
            ...
            <el-form-item :label="$i18n.t('USER_EMAIL')" :error="errors.user_email">
                <el-input v-model="data.user_email" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('USER_EMAIL') })"></el-input>
            </el-form-item>
            <el-form-item :label="$i18n.t('ADDRESS')" :error="errors.address">
