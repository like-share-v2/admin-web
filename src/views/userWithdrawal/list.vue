    ...
    <div>
        ...
        <div class="table-body">
            ...
            <el-table border style="width: 100%;" stripe :data="data" v-loading="loading">
                ...
                <el-table-column align="center" prop="ifsc" label="IFSC" :min-width="100"></el-table-column>
                <el-table-column align="center" prop="status" :label="$i18n.t('STATUS')" :min-width="100">
                    <template slot-scope="scope">
                        ...
                        <el-tag v-else-if="scope.row.status === 3" type="primary">{{ $i18n.t('WITHDRAWAL_STATUS_3') }}</el-tag>
                        <el-tag v-else-if="scope.row.status === 4" type="warning">{{ $i18n.t('WITHDRAWAL_STATUS_4') }}</el-tag>
